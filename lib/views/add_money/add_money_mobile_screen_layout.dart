  ...
  _paymentGatewayWidget(BuildContext context) {
    return Column(
      children: [
        ...
        TitleHeading5Widget(
          text:
              "${Get.find<LanguageController>().getTranslation(Strings.exchangeRate)}: ${"1"} ${controller.baseCurrency.value} = ${controller.exchangeRate.value} ${controller.currencyCode.value} ",
          color: Theme.of(context).primaryColor,
          fontWeight: FontWeight.w500,
        ),
        Container(
