...
MarketplaceBuyModel marketplaceBuyModelFromJson(String str) =>
    MarketplaceBuyModel.fromJson(json.decode(str));

String marketplaceBuyModelToJson(MarketplaceBuyModel data) =>
