...
AddMoneyFlutterWavePaymentModel flutterWavePaymentModelFromJson(String str) =>
    AddMoneyFlutterWavePaymentModel.fromJson(json.decode(str));

String flutterWavePaymentModelToJson(AddMoneyFlutterWavePaymentModel data) =>
...
class AddMoneyFlutterWavePaymentModel {
  ...
  factory AddMoneyFlutterWavePaymentModel.fromJson(Map<String, dynamic> json) =>
      AddMoneyFlutterWavePaymentModel(
